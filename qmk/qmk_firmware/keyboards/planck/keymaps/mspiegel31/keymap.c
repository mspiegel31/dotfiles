...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT, KC_MUTE, KC_MPLY, KC_4,    KC_5,    KC_6,    KC_MINS, _______,
    _______, _______, _______, KC_PLUS, KC_MINS, _______, _______, KC_1,    KC_2,    KC_3,    KC_PLUS, _______,

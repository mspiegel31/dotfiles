...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_PERC, KC_UNDS, KC_PLUS, KC_MINS, KC_ASTR, KC_CIRC, KC_LPRN, KC_RPRN, _______, KC_BSLS, _______,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_EQL,  KC_MPLY,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______,
    _______, KC_7,    KC_8,    KC_9,    KC_MINS, _______, _______,  KC_MUTE, _______, _______, _______, _______,

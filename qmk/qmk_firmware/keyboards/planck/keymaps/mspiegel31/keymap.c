...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_PIPE, KC_LT,   KC_GT,   KC_BSLS, _______,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, _______, KC_4,    KC_5,    KC_6,    KC_MINS, _______,
    _______, _______, _______, KC_MUTE, KC_MPLY, _______, _______, KC_1,    KC_2,    KC_3,    KC_PLUS, _______,

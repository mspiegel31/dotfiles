...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_PLUS, KC_MINS, _______, _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,
...
[_RAISE] = LAYOUT_planck_grid(
  ...
  _______,   _______,  KC_PERC, KC_UNDS, KC_MINS, _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______,

...
[_GAME_MODE] = LAYOUT_planck_grid(
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,      KC_H,     KC_J,   KC_K,    KC_L,    TD(SEMI_EQ), KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,     KC_M,   KC_COMM, KC_DOT,  KC_SLSH,     KC_SFTENT,
    KC_LCTL, FN,      KC_LALT, KC_LGUI, LOWER,   KC_SPC,    KC_SPC,   bRAISE,  KC_LEFT, KC_DOWN, KC_UP,       KC_RIGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, KC_PLUS, KC_BSLS, _______,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_BSLS,

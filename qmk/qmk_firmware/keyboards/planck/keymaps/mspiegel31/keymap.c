...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_TILD, KC_LT,   KC_GT,   KC_EQL,  KC_AMPR, KC_PIPE, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, _______,
    _______, _______, KC_UNDS, KC_PLUS, KC_MINS, _______, _______, KC_LPRN, KC_RPRN, _______, KC_BSLS, _______,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   5  |   6  |   7  |   8  |   =  | Play | Prev | Vol- | Vol+ | Next |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   9  |   0  |   +  |   -  |      |      | Mute |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_5,    KC_6,    KC_7,    KC_8,    KC_EQL,  KC_MPLY,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______,
    _______, KC_9,    KC_0,    KC_PLUS, KC_MINS, _______, _______,  KC_MUTE, _______, _______, _______, _______,
  ...
  */
  [_SPACE_FN] = LAYOUT_planck_grid(
      KC_ESC,   XXXXXXX, XXXXXXX,  KC_BTN1,   KC_BTN2,  XXXXXXX,  XXXXXXX,  XXXXXXX, KC_BRID, KC_BRIU,  XXXXXXX, XXXXXXX,

...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,     KC_M,   TD(COMMA_MIN), KC_DOT,  KC_SLSH,     KC_ENT,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______, _______, _______,
    _______, _______, _______, KC_MUTE, KC_MPLY, _______, KC_MINS, KC_EQL,  _______, _______, KC_BSLS, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_BRID, KC_BRIU, _______, _______, KC_EQL,   KC_PLUS, KC_MINS, KC_UNDS,  _______,

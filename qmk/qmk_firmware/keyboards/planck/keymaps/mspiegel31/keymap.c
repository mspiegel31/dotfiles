...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_EQL,  _______,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______,
    _______, KC_7,    KC_8,    KC_9,    KC_MINS, _______, _______,  KC_MUTE, KC_MPLY, _______, _______, _______,

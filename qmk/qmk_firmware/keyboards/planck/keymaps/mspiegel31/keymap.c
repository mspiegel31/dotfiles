...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_MINS, KC_PLUS, _______, _______, KC_PIPE, KC_LT,   KC_GT,   KC_BSLS, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_MINS, KC_PLUS, _______, _______, KC_MUTE,  KC_MPLY, _______, _______,  _______,

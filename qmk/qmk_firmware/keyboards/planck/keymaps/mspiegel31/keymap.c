...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  TD(DBCBR),  TD(DBBRC),  KC_MUTE, KC_VOLU, KC_MPLY,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLS, KC_PGDN, _______
),

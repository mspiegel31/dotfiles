...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT, _______, _______, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, _______,
    _______, _______, _______, KC_MUTE, KC_MPLY, _______, _______, KC_LPRN, KC_RPRN, _______, KC_BSLS, _______,

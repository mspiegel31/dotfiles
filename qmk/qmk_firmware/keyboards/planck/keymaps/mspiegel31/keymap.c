 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  FN2  | Alt  | GUI  |Lower|    Space    |Raise |   '  | Left | Down |Right |
 * `-----------------------------------------------------------------------------------`
 */
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, _______,
    _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  KC_LT,   KC_GT,   _______, KC_BSLS,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, _______, _______, _______, _______, KC_LEFT,  KC_UP,   KC_DOWN, KC_RIGHT, _______,
    _______, _______, _______, _______, _______, _______, KC_UNDS, KC_PLUS,  _______, _______, KC_PGUP,  _______,

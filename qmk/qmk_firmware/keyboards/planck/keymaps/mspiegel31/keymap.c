...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,     KC_M,   TD(COMMA_MIN), KC_DOT,  KC_UP,       KC_SLSH,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  KC_LT,   KC_GT,   KC_PGUP, KC_BSLS,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, KC_UNDS, KC_MUTE,  KC_MPLY, _______, KC_BRIU,  _______,

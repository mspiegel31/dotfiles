...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, KC_MPLY, KC_MUTE, KC_MINS, KC_PLUS, _______,  _______, _______, _______, _______,  _______,
  ...
  */
  [_SPACE_FN] = LAYOUT_planck_grid(
      C(KC_GRV), XXXXXXX, KC_BTN2,  KC_MS_U,   KC_BTN1,  XXXXXXX,  XXXXXXX,  KC_BRID, KC_WH_U, KC_BRIU,  XXXXXXX, XXXXXXX,

 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  FN  | Alt  | GUI  |Lower |    Space    |Raise | Enter| Left | Down |Right |
 * `-----------------------------------------------------------------------------------
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, FN,      KC_LALT, KC_LGUI, LOWER,   SPACE_FN,  SPACE_FN, RAISE,  KC_ENT,  KC_LEFT, KC_DOWN, KC_RIGHT
),
...
[_RAISE] = LAYOUT_planck_grid(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR,  KC_LPRN,  KC_RPRN, KC_EQL,  KC_BSPC,
    KC_DEL,  _______, _______, _______, _______, _______, _______, KC_UNDS,  KC_LCBR,  KC_RCBR, KC_MINS, KC_PIPE,
    _______, _______, _______, _______, _______, _______, _______, KC_ASTR,  KC_LBRC,  KC_RBRC, KC_PGUP, KC_BSLS,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS, _______, KC_PLUS, KC_MUTE,
    _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  _______, _______, KC_VOLU, KC_MPLY,

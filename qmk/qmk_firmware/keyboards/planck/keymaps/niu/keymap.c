...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR,  KC_PIPE,  _______, _______, KC_PIPE,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS, _______, _______, KC_MUTE,

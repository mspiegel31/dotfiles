...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  TAB_RAISE,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,      KC_H,     KC_J,   KC_K,    KC_L,    TD(SEMI_EQ), KC_QUOT,
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, _______, _______, _______, KC_LPRN, KC_RPRN, KC_AMPR, KC_PIPE, _______,
  _______, KC_UNDS, KC_LT,   KC_GT,   KC_EQL,  _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______,
  _______, _______, KC_PERC, KC_PLUS, KC_MINS, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______,

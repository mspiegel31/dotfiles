...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  KC_TILD, _______, _______, _______, _______, _______, _______, KC_PIPE, KC_LPRN, KC_RPRN, _______, _______,
  _______, _______, KC_LT,   KC_GT,   KC_EQL,  _______, _______, KC_AMPR, KC_LCBR, KC_RCBR, _______, _______,
  _______, _______, KC_PERC, KC_PLUS, KC_MINS, _______, _______, KC_UNDS, KC_LBRC, KC_RBRC, _______, _______,
...
[_LOWER] = LAYOUT_preonic_grid(
  _______,   KC_1,    KC_2,    KC_3,    _______, _______, _______, _______, _______, _______, _______, KC_DEL,
  C(KC_GRV), KC_4,    KC_5,    KC_6,    _______, _______, _______, _______, _______, _______, _______, _______,
  _______,   KC_7,    KC_8,    KC_9,    KC_EQL,  _______, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______,
  _______,   _______, KC_0,    KC_PLUS, KC_MINS, _______, _______, KC_MPLY, KC_MUTE, _______, _______, _______,
  _______,   _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
